...
7. **AAP version?** (only if product is Ansible)
   ...
   Options:
   - AAP 2.5: Current GA release. Image: base-zero-aap-2.5-container-ce. Stable, well-tested, most labs use this.
   - AAP 2.6: Latest release with Gateway API, platform-level OPA policy, and improved EDA. Image: base-zero-aap-2.6-container-ce. Use for labs demonstrating new 2.6 features.
